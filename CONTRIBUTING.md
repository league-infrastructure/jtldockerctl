...
Welcome to `jtldockerctl` contributor's guide.
...
If you experience bugs or general issues with `jtldockerctl`, please have a look
...
You can help improve `jtldockerctl` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`jtldockerctl` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `jtldockerctl`'s files. While this mechanism can
...
```
conda create -n jtldockerctl python=3 six virtualenv pytest pytest-cov
conda activate jtldockerctl
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/jtldockerctl.git
   cd jtldockerctl
   ```
...
5. Install [pre-commit]:
   ...
   `jtldockerctl` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/jtldockerctl
[issue tracker]: https://github.com/<USERNAME>/jtldockerctl/issues
